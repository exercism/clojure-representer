...
(ns clojure-representer.analyzer.passes.jvm.infer-tag
  (:require [clojure-representer.analyzer.utils :refer [arglist-for-arity]]
            [clojure-representer.analyzer.jvm.utils :as u]
            [clojure-representer.analyzer.env :as env]
            [clojure.set :refer [rename-keys]]
            [clojure-representer.analyzer.passes.trim :refer [trim]]
