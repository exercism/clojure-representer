...
(ns clojure-representer.analyzer
   ...
   * var?
   ...
   Setting up the global env is also required, see analyzer.env

   See analyzer.core-test for an example on how to setup the analyzer."
  (:refer-clojure :exclude [macroexpand-1 macroexpand var? record? boolean? update-keys update-vals])
  (:require [clojure-representer.analyzer.utils :refer :all]
