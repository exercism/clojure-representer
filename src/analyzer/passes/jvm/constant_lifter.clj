(ns analyzer.passes.jvm.constant-lifter
  (:require [analyzer.passes.constant-lifter :as orig]
            [analyzer :refer [analyze-const]]
            [analyzer.utils :refer [constant? classify]]
            [analyzer.passes.jvm.analyze-host-expr :refer [analyze-host-expr]]
            [analyzer.passes.elide-meta :refer [elide-meta]]))
